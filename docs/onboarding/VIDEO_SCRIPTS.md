...
## 1. Dashboard (`dashboard.mp4`) — 75 s

**Goal:** Orient the user, show the core value prop in 60–75 s.
...
- Item cards with AI summary chip
- Category filter pills
- Share icon on a card
- Trial banner CTA

---

## 2. Saves (`saves.mp4`) — 60 s

**Goal:** Teach the full save workflow end-to-end.
...
## 3. Sharing (`sharing.mp4`) — 70 s

**Goal:** Show boards, sharing modes, and the friends system.
...
| 42–54 s | Share a single item via Share button → copy link | "Share individual items as public links — anyone can view without an account."                  |
| 54–70 s | Show Public / Couples / Family / Friends modes  | "Public, couples, family, or friends-only — you control who sees what, always."                 |

---

## 4. Support (`support.mp4`) — 55 s

**Goal:** Show the ticket system, AI bot, and documentation.
...
## 5. Subscription (`subscription.mp4`) — 50 s

**Goal:** Explain the free/pro/family tiers and the 7-day trial.
...
| 42–50 s | Referral banner: "Earn 1 free month"           | "Refer a friend and earn a free month of Pro — no cap on referrals."                        |

---

## 6. Events (`events.mp4`) — 60 s

**Goal:** Show event discovery, saving, calendar integration, and reminders.

### Storyboard

| Time    | Visual                                          | Voiceover                                                                                  |
|---------|------------------------------------------------|-------------------------------------------------------------------------------------------|
| 0–6 s   | Events page, AI-curated event cards             | "The Events page surfaces AI-curated local events — gigs, markets, shows, and more."     |
...
- Use **Loom** or **OBS** for screen recording at 1920×1080
- Export final cut as `H.264 MP4` at `3–5 Mbps` bitrate
- Keep files **under 10 MB** (compress with HandBrake if needed)
- Export poster frame as `JPEG @ 80% quality` — aim for < 150 KB
- Record voiceover after screen capture to match exactly
- Use a **lapel mic** or quality USB mic — clear audio matters more than perfect video
- Add **subtle zoom animations** to highlight UI elements (built into Loom Pro)
- No background music in first 3 s (videos autoplay muted — silence = better UX)
...
Replace the `.placeholder` files in this directory with the real assets before go-live.
