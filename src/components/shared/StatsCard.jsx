...
export default function StatsCard({ title, value, icon: Icon, accent = "#00BFFF", trend }) {
  return (
    <div className="glass-card rounded-2xl p-5 relative overflow-hidden group hover:border-opacity-50 transition-all duration-300"
