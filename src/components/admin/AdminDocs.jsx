...
const DOC_TEMPLATES = [
  { id: "onboarding", label: "Onboarding Guide", icon: "🚀", prompt: "Write a comprehensive onboarding guide for Klip4ge, a social media content saving & AI organization app. Cover: getting started, connecting social accounts, using AI summaries, creating boards, and pro tips. Use markdown with headers, bullet points, and examples." },
  { id: "faq", label: "FAQ", icon: "❓", prompt: "Write a detailed FAQ for Klip4ge covering: what it is, how saving works, social connections, AI features, pricing/plans, privacy & data security, sharing boards, and troubleshooting common issues. Use markdown Q&A format." },
  { id: "api_guide", label: "API Token Guide", icon: "🔑", prompt: "Write a step-by-step guide for Klip4ge users on how to get API tokens for: Instagram Graph API, Pinterest API, Twitter/X API v2, TikTok for Developers. Include links, screenshots descriptions, and common gotchas. Use markdown with numbered steps per platform." },
  { id: "privacy", label: "Privacy Policy Summary", icon: "🛡️", prompt: "Write a clear, user-friendly privacy policy summary for Klip4ge explaining: what data is collected (saved items, social tokens), how it's stored (encrypted), what we never do (no posting on user behalf), user rights, and data deletion. Use markdown." },
  { id: "release_notes", label: "Release Notes Template", icon: "📋", prompt: "Write a release notes template for Klip4ge v2.0 covering: new features (Facebook integration, freemium gating, admin dashboard, AI ticket drafting), improvements (UI polish, performance), and bug fixes. Use markdown with version header and sections." },
  { id: "support_ticket_flow", label: "Support Ticket Flow", icon: "🎫", prompt: "Write user-facing support documentation for Klip4ge covering the support ticket workflow. Include: (1) How to contact support via the chat bot on any page, (2) How the AI bot answers common questions instantly, (3) How to escalate to a human agent — clicking 'Talk to a person' in the chat creates a support ticket, (4) What happens after escalation — ticket is created, team reviews it, and responds in the ticket, (5) How to view your open tickets in the Support page under 'My Tickets'. Format with step-by-step numbered lists, tips, and expected response times. Use friendly markdown." },
  { id: "event_calendar_flow", label: "Events & Calendar Guide", icon: "📅", prompt: "Write user-facing support documentation for Klip4ge covering the event saving and calendar flow. Include: (1) How to browse and discover events on the Events page (powered by Ticketmaster), (2) How to save an event to your Saves vault, (3) How to add a saved event to your calendar — clicking 'Add to Calendar' generates a downloadable .ics file compatible with Google Calendar, Apple Calendar, and Outlook, (4) How to enable event reminders — toggling 'Remind Me' on a saved event will send email reminders 7 days before, 24 hours before, and 1 hour before (Premium/Family only), (5) How to mark a ticket as purchased. Use friendly markdown with sections and tips." },
  { id: "referral_flow", label: "Referral Program Guide", icon: "🎁", prompt: "Write user-facing support documentation for Klip4ge's referral program. Include: (1) How to find your unique referral link in Settings under 'Refer & Earn', (2) How to share it with friends via link or social, (3) What happens when a friend signs up using your link — they get started on Klip4ge and you earn a bonus, (4) Bonus types: a free month of Pro when the referred friend subscribes, (5) How to track your referrals and bonus status in the Referral panel, (6) Referral rules: one bonus per referred user, friend must subscribe for bonus to apply. Use friendly markdown with a FAQ section at the end." },
  { id: "family_flow", label: "Family Plan Guide", icon: "👨‍👩‍👧", prompt: "Write user-facing support documentation for Klip4ge's Family Premium plan. Include: (1) What the Family plan includes — up to 5 members, shared boards, parent controls, (2) How to invite family members from Settings → Family Management, (3) Role types: Parent (full access, manages the group) vs Child (limited access, child-safe mode on by default), (4) Child-safe mode explained — filters explicit content, hides upgrade banners, limits social sources, (5) COPPA compliance — for children under 13, parental consent is required and is recorded, (6) How to adjust child permissions as a parent — toggling child-safe mode, managing content filters, (7) How members accept invites and activate their accounts, (8) How to remove a family member. Use clear, friendly markdown with sections." },
];
